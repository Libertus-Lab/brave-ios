...
// MARK:- Web3DomainHandler.swift
extension Strings {
  // Generic
  public static let web3DomainInterstitialPageTAndU = NSLocalizedString("Web3DomainInterstitialPageTAndU", tableName: "BraveShared", bundle: .module, value: "terms of use", comment: "Hyper link copy displayed as part of 'snsDomainInterstitialPageDescription'. It will redirect user to the 'terms of use' webpage of the server that Brave uses to resolve SNS domain.")
  public static let web3DomainInterstitialPagePrivacyPolicy = NSLocalizedString("Web3DomainInterstitialPagePrivacyPolicy", tableName: "BraveShared", bundle: .module, value: "privacy policy", comment: "Hyper link copy displayed as part of 'snsDomainInterstitialPageDescription'. It will redirect user to the privay policy webpage of the server that Brave uses to resolve SNS domain.")
  public static let web3DomainInterstitialPageButtonDisable = NSLocalizedString("Web3DomainInterstitialPageButtonDisable", tableName: "BraveShared", bundle: .module, value: "Disable", comment: "Title on the button that users can click to disable Brave to resolve the ENS/SNS domain they entered.")
  // SNS
  ...
  // ENS
  public static let ensDomainInterstitialPageTitle = NSLocalizedString("EnsDomainInterstitialPageTitle", tableName: "BraveShared", bundle: .module, value: "Enable support of Ethereum Name Service (ENS) in Brave?", comment: "Title displayed when users chose Brave to ask them if they want the ENS domain to be resolved every time they enter one.")
  public static let ensDomainInterstitialPageDescription = NSLocalizedString("EnsDomainInterstitialPageDescription", tableName: "BraveShared", bundle: .module, value: "Brave will be using Infura to resolve .eth domain names that are on Ethereum Name Service (ENS). Brave hides your IP address. If you enable this, Infura will see that someone is trying to visit these .eth domains but nothing else. See Infura's <a href=%@>%@</a> and <a href=%@>%@</a>.", comment: "Description displayed when users chose Brave to ask them if they want the ENS to be resolved every time they enter one. The first '%@' will be replaced with a link to Infura's terms of use page. The second '%@' will be replaced with the value of 'Web3DomainInterstitialPageTAndU'. The third '%@' will be replaced with a link to Infura's privacy policy page. The last '%@' will be replaced with the value of 'Web3DomainInterstitialPagePrivacyPolicy'.")
  public static let ensDomainInterstitialPageButtonProceed = NSLocalizedString("EnsDomainInterstitialPageButtonProceed", tableName: "BraveShared", bundle: .module, value: "Proceed using Infura server", comment: "Title on the button that users can click to enable Brave to resolve the ENS domain they entered.")
  // ENS offchain
  public static let ensOffchainDomainInterstitialPageTitle = NSLocalizedString("EnsOffchainDomainInterstitialPageTitle", tableName: "BraveShared", bundle: .module, value: "Enable support of Ethereum Name Service (ENS) offchain lookup in Brave?", comment: "Title displayed when users chose Brave to ask them if they want the ENS Offchain domain to be resolved every time they enter one.")
  public static let ensOffchainDomainInterstitialPageDescription = NSLocalizedString("EnsOffchainDomainInterstitialPageDescription", tableName: "BraveShared", bundle: .module, value: "This .eth domain name is stored offchain and will be resolved by a third party gateway. If you enable ENS offchain lookup, the third party gateway will see that you're trying to visit the .eth domain. <a href=%@>%@</a>.", comment: "Description displayed when users chose Brave to ask them if they want the ENS to be resolved every time they enter one. The first '%@' will be replaced with a link to Brave Wallet's offchain lookup privacy considerations. The second '%@' will be replaced with the value of 'ensOffchainDomainInterstitialLearnMore'.")
  public static let ensOffchainDomainInterstitialLearnMore = NSLocalizedString(
    "EnsOffchainDomainInterstitialLearnMore", tableName: "BraveShared", bundle: .module, value: "Learn more", comment: "")
  public static let ensOffchainDomainInterstitialPageButtonProceed = NSLocalizedString("EnsOffchainDomainInterstitialPageButtonProceed", tableName: "BraveShared", bundle: .module, value: "Proceed with offchain lookup", comment: "Title on the button that users can click to enable Brave to resolve the ENS offchain lookup for the domain they entered.")
}
