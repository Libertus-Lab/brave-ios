...
extension Web3Service {
  ...
  var errorTitle: String {
    switch self {
    case .solana:
      return Strings.snsDomainInterstitialPageTitle
    case .ethereum:
      return Strings.ensDomainInterstitialPageTitle
    case .ethereumOffchain:
      return Strings.ensOffchainDomainInterstitialPageTitle
    }
  }
  ...
  var errorDescription: String {
    ...
    case .solana:
      ...
      return String.localizedStringWithFormat(
        Strings.snsDomainInterstitialPageDescription,
        termsOfUseUrl,
        Strings.web3DomainInterstitialPageTAndU,
        privacyPolicyUrl,
        Strings.web3DomainInterstitialPagePrivacyPolicy)
    case .ethereum:
      ...
      return String.localizedStringWithFormat(
        Strings.ensDomainInterstitialPageDescription,
        termsOfUseUrl,
        Strings.web3DomainInterstitialPageTAndU,
        privacyPolicyUrl,
        Strings.web3DomainInterstitialPagePrivacyPolicy)
    case .ethereumOffchain:
      ...
      return String.localizedStringWithFormat(
        Strings.ensOffchainDomainInterstitialPageDescription,
        learnMore,
        Strings.ensOffchainDomainInterstitialLearnMore)
    }
  }
  
  var disableButtonTitle: String {
    Strings.web3DomainInterstitialPageButtonDisable
  }
  
  var proceedButtonTitle: String {
    switch self {
    case .solana:
      return Strings.snsDomainInterstitialPageButtonProceed
    case .ethereum:
      return Strings.ensDomainInterstitialPageButtonProceed
    case .ethereumOffchain:
      return Strings.ensOffchainDomainInterstitialPageButtonProceed
    }
  }
}
